...
On Amazon Linux and supported RHEL-family platforms, managed Java currently supports Java 17 only through Amazon Corretto. Debian, Ubuntu, and Fedora use Eclipse Temurin packages by default. Set `manage_java false` if you need to supply a different JDK externally.
