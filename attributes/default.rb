...
default[:kafka][:broker][:background_threads] = nil
...
default[:kafka][:broker][:queued_max_requests] = nil
...
#
# NOTE: only for versions > 0.8.0
default[:kafka][:broker][:advertised_host_name] = nil
...
#
# NOTE: only for versions > 0.8.0
default[:kafka][:broker][:advertised_port] = nil

#
# The SO_SNDBUFF buffer the server prefers for socket connections.
default[:kafka][:broker][:socket_send_buffer_bytes] = nil

#
# The SO_RCVBUFF buffer the server prefers for socket connections.
default[:kafka][:broker][:socket_receive_buffer_bytes] = nil
...
default[:kafka][:broker][:log_segment_bytes] = nil
...
#
# NOTE: only for 0.8.0
default[:kafka][:broker][:log_roll_hours_per_topic] = {}
...
#
# NOTE: only for versions > 0.8.0
default[:kafka][:broker][:log_retention_minutes] = nil
...
#
# NOTE: only for 0.8.0
default[:kafka][:broker][:log_retention_hours] = nil
...
#
# NOTE: only for 0.8.0
default[:kafka][:broker][:log_retention_hours_per_topic] = {}

#
# The amount of data to retain in the log for each topic-partitions.
default[:kafka][:broker][:log_retention_bytes] = nil
...
#
# NOTE: only for 0.8.0
default[:kafka][:broker][:log_retention_bytes_per_topic] = {}
...
#
# NOTE: only for versions > 0.8.0
default[:kafka][:broker][:log_retention_check_interval_ms] = nil
...
default[:kafka][:broker][:log_flush_interval_ms] = nil
...
#
# NOTE: only for 0.8.0
default[:kafka][:broker][:log_flush_interval_ms_per_topic] = {}

#
# The frequency in ms that the log flusher checks whether any log is eligible
# to be flushed to disk.
default[:kafka][:broker][:log_flush_scheduler_interval_ms] = nil
...
default[:kafka][:broker][:auto_create_topics] = nil
...
# without locking.
default[:kafka][:broker][:log_delete_delay_ms] = nil

#
# The frequency with which we checkpoint the last flush point for logs for
# recovery.
default[:kafka][:broker][:log_flush_offset_checkpoint_interval_ms] = nil
...
#
# NOTE: only for versions > 0.8.0
default[:kafka][:broker][:log_cleanup_policy] = nil
...
default[:kafka][:broker][:log_cleaner_enable] = nil

#
# The number of threads to use for cleaning logs in log compaction.
default[:kafka][:broker][:log_cleaner_threads] = nil
...
default[:kafka][:broker][:log_cleaner_io_max_bytes_per_second] = nil
...
default[:kafka][:broker][:log_cleaner_dedupe_buffer_size] = nil

#
# The size of the I/O chunk used during log cleaning.
# You probably don't need to change this.
default[:kafka][:broker][:log_cleaner_io_buffer_size] = nil

#
# The load factor of the hash table used in log cleaning.
# You probably don't need to change this.
default[:kafka][:broker][:log_cleaner_io_buffer_load_factor] = nil

#
# The interval between checks to see if any logs need cleaning.
default[:kafka][:broker][:log_cleaner_backoff_ms] = nil
...
default[:kafka][:broker][:log_cleaner_min_cleanable_ratio] = nil

#
# The amount of time to retain delete tombstone markers for log compacted topics.
default[:kafka][:broker][:log_cleaner_delete_retention_ms] = nil

# Replication configuration
#
# The socket timeout for commands from the partition management controller to
# the replicas.
default[:kafka][:broker][:controller_socket_timeout_ms] = nil

#
# The buffer size for controller-to-broker-channels.
default[:kafka][:broker][:controller_message_queue_size] = nil

#
# The default replication factor for automatically created topics.
default[:kafka][:broker][:default_replication_factor] = nil
...
# dead.
default[:kafka][:broker][:replica_lag_time_max_ms] = nil
...
default[:kafka][:broker][:replica_lag_max_messages] = nil

#
# The socket timeout for network requests to the leader for replicating data.
default[:kafka][:broker][:replica_socket_timeout_ms] = nil

#
# The socket receive buffer for network requests to the leader for replicating
# data.
default[:kafka][:broker][:replica_socket_receive_buffer_bytes] = nil
...
default[:kafka][:broker][:replica_fetch_max_bytes] = nil
...
default[:kafka][:broker][:replica_fetch_wait_max_ms] = nil

#
# Minimum bytes expected for each fetch response for the fetch requests from
# the replica to the leader.
default[:kafka][:broker][:replica_fetch_min_bytes] = nil

#
# Number of threads used to replicate messages from leaders.
default[:kafka][:broker][:num_replica_fetchers] = nil

#
# The frequency with which each replica saves its high watermark to disk to
# handle recovery.
default[:kafka][:broker][:replica_high_watermark_checkpoint_interval_ms] = nil

#
# The purge interval (in number of requests) of the fetch request purgatory.
default[:kafka][:broker][:fetch_purgatory_purge_interval_requests] = nil

#
# The purge interval (in number of requests) of the producer request purgatory.
default[:kafka][:broker][:producer_purgatory_purge_interval_requests] = nil
...
default[:kafka][:broker][:controlled_shutdown_enabled] = nil

#
# Number of retries to complete the controlled shutdown successfully before
# executing an unclean shutdown.
default[:kafka][:broker][:controlled_shutdown_max_retries] = nil

#
# Backoff time between shutdown retries.
default[:kafka][:broker][:controlled_shutdown_retry_backoff_ms] = nil
...
default[:kafka][:broker][:auto_leader_rebalance_enable] = nil
...
default[:kafka][:broker][:leader_imbalance_per_broker_percentage] = nil

#
# The frequency with which to check for leader imbalance.
default[:kafka][:broker][:leader_imbalance_check_interval_seconds] = nil
...
default[:kafka][:broker][:offset_metadata_max_bytes] = nil
...
default[:kafka][:broker][:zookeeper_path] = nil
